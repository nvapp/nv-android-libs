...
public class Tracker1D {
	 ...
	 * 
	 * @param timeStep
	 *            Delta time between predictions. Usefull to calculate speed.
	 * @param processNoise
	 *            Standard deviation to calculate noise covariance from.
	 */
	 ...
	 * <p>
	 * Should be called after creation, unless position and velocity are assumed
	 * to be both zero.
	 * 
	 * @param position
	 * @param velocity
	 ...
	 * 
	 * @param acceleration
	 *            Should be 0 unless there's some sort of control input (a gas
	 *            pedal, for instance).
	 */
